	...
	IOwnedBySelectorNested
{
	...
	fun posixgroup(group: String? = null, followsymlinks: Boolean? = null) {
		component.addPosixGroup(PosixGroupSelector().apply {
			_init(group, followsymlinks)
		})
	}
	fun posixpermissions(permissions: String? = null, followsymlinks: Boolean? = null) {
		component.addPosixPermissions(PosixPermissionsSelector().apply {
